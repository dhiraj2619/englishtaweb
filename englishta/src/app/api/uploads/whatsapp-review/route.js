...
const CLOUDINARY_FOLDER = process.env.CLOUDINARY_WHATSAPP_REVIEWS_FOLDER || "englishta/whatsapp-reviews";
...
export async function POST(request) {
  try {
    ...
    return NextResponse.json(
      { success: false, message: "WhatsApp review image upload failed.", error: error.message },
      { status: 500 },
    );
  }
}

...
const CLOUDINARY_FOLDER = process.env.CLOUDINARY_DEMO_LECTURE_FOLDER || "englishta/demo-lecture";
...
export async function POST(request) {
  try {
    ...
    return NextResponse.json(
      { success: false, message: "Demo lecture thumbnail upload failed.", error: error.message },
      { status: 500 },
    );
  }
}

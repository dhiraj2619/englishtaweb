...
const CLOUDINARY_FOLDER = process.env.CLOUDINARY_FOLDER ? `${process.env.CLOUDINARY_FOLDER}/blogs` : "englishta/blogs";
...
export async function POST(request) {
  try {
    ...
    return NextResponse.json(
      { success: false, message: "Blog thumbnail upload failed.", error: error.message },
      { status: 500 },
    );
  }
}
